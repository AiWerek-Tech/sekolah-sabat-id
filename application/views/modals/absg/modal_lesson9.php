<!-- application/views/modals/absg/modal_lesson9.php -->
<div class="modal fade" id="modallesson9" tabindex="-1" aria-labelledby="modallesson9Label" aria-hidden="true">
      <div class="modal-dialog modal-lg">
          <div class="modal-content">
              <div class="modal-header d-flex justify-content-between align-items-center">
                <span class="modal-title text-center flex-grow-1" id="modallesson9Label">
                    Pelajaran 9 - <?= $judul_pelajaran9?> (<?= $triwulan?>)
                </span>
                <div>
                    <a href="#" id="fullscreenIcon9" class="mr-3 text-secondary"><i class="fas fa-expand-arrows-alt"></i></a>
              ...
              <div class="modal-body">
                  <iframe id="lesson9Content" src="https://sabbath-school.adventech.io/in/2024-03/09/01" style="width: 100%; height: 100%; border: none;" scrolling="auto"></iframe>
              </div>

...
<!-- Hilangkan dan Muncul menu Notifikation pada mobile ketika klik menu -->
<!-- <script>
    document.addEventListener("DOMContentLoaded", function () {
        ...
        menuToggle.addEventListener('click', function () {
            // Tambahkan kelas hide-notification saat menu diklik
            notificationMobile.classList.add('hide-notification');
        });
    });
    const closeButton = document.querySelector('.close');

    closeButton.addEventListener('click', function () {
        notificationMobile.classList.remove('hide-notification');
    });
</script> -->

                    ...
                    <div class="carousel__item-text__wrap">
                        <div class="layout-container">
                            <div class="carousel__item-text  spacing--half">
                                ...
                                <a href="<?= base_url('') ?>pages/ss-anak-anak"
                                    class="carousel__item-cta btn theme--secondary-background-color">Get Started</a>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="layout-container">
                            <div class="carousel__item-text spacing--half">
                                <div>
                                    <h2
                                        class="carousel__item-heading font--tertiary--xl theme--primary-transparent-background-color">
                                        Beginner (usia lahir-2)
                                    </h2>
                                    <br>
                                    <div
                                        class="carousel__item-dek pad-half--btm theme--primary-transparent-background-color">
                                        <p>Kurikulum GraceLink untuk Beginner ditujukan untuk anak usia lahir hingga 2
                                            tahun. Namun, materi untuk Beginner dan TK dapat disesuaikan untuk anak usia
                                            3 tahun.</p>
                                    </div>
                                </div>
                        ...
                        <div class="layout-container">
                            <div class="carousel__item-text spacing--half">
                                <div>
                                    ...
                                    <div
                                        class="carousel__item-dek pad-half--btm theme--primary-transparent-background-color">
                                        <p>GraceLink Kindergarten is for children ages 3-4.</p>
                                    </div>
                                </div>
                                <a href="kindergarten"
                                    class="carousel__item-cta btn theme--secondary-background-color">Find Out More</a>
                        ...
                        <div class="layout-container">
                            <div class="carousel__item-text spacing--half">
                                <div>
                                    ...
                                    <div
                                        class="carousel__item-dek pad-half--btm theme--primary-transparent-background-color">
                                        <p>GraceLink Primary is for children ages 5-9.</p>
                                    </div>
                                </div>

<!-- application/views/modals/absg/modal_lesson1.php -->
<div class="modal fade" id="modalLesson1" tabindex="-1" aria-labelledby="modalLesson1Label" aria-hidden="true">
      <div class="modal-dialog modal-lg">
          <div class="modal-content">
              <div class="modal-header d-flex justify-content-between align-items-center">
                <span class="modal-title text-center flex-grow-1" id="modalLesson1Label">
                    Pelajaran 1 - <?= $judul_pelajaran1?> (<?= $triwulan?>)
                </span>
                <div>
                    <a href="#" id="fullscreenIcon1" class="mr-3 text-secondary"><i class="fas fa-expand-arrows-alt"></i></a>
              ...
              <div class="modal-body">
                  <iframe id="lesson1Content" src="https://sabbath-school.adventech.io/in/2024-03/01/01" style="width: 100%; height: 100%; border: none;" scrolling="auto"></iframe>
              </div>

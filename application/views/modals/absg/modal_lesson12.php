<!-- application/views/modals/absg/modal_lesson12.php -->
<div class="modal fade" id="modallesson12" tabindex="-1" aria-labelledby="modallesson12Label" aria-hidden="true">
      <div class="modal-dialog modal-lg">
          <div class="modal-content">
              <div class="modal-header d-flex justify-content-between align-items-center">
                <span class="modal-title text-center flex-grow-1" id="modallesson12Label">
                    Pelajaran 12 - <?= $judul_pelajaran12?> (<?= $triwulan?>)
                </span>
                <div>
                    <a href="#" id="fullscreenIcon12" class="mr-3 text-secondary"><i class="fas fa-expand-arrows-alt"></i></a>
              ...
              <div class="modal-body">
                  <iframe id="lesson12Content" src="https://sabbath-school.adventech.io/in/2024-03/12/01" style="width: 100%; height: 100%; border: none;" scrolling="auto"></iframe>
              </div>

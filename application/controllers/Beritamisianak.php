...
class Beritamisianak extends CI_Controller {
    ...
    public function store() {
        ...
        // $this->form_validation->set_rules('dikisahkan_oleh', 'Dikisahkan Oleh', 'required');
        // $this->form_validation->set_rules('asal_negara', 'Asal Kota/Negara', 'required');
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            $data = [
                ...
                'pendahuluan_teks_cerita' => $this->input->post('pendahuluan_teks_cerita'),
                'dikisahkan_oleh' => $this->input->post('dikisahkan_oleh'), // Kolom baru
                'asal_negara' => $this->input->post('asal_negara'),         // Kolom baru
                'story_tips' => $this->input->post('story_tips'),           // Kolom baru
                'fakta_singkat' => $this->input->post('fakta_singkat'),     // Kolom baru
    ...
    public function edit($id) {
        ...
        if (!$berita) {
            ...
            redirect('admin/berita-misi/anak-anak'); // Alihkan ke halaman lain jika data tidak ada
        }
       ...
       $triwulan = $this->Tahun_model->getAllTriwulan();
        ...
        $view_data = [
            ...
            'sidebar' => 'admin/_template/v_admin_sidebar',
            'breadcrumb' => 'admin/_template/v_breadcrumb_primary',
            'page' => 'admin/beritamisi/v_bma_edit', 
            'footer' => 'admin/_template/v_admin_footer',
            'tp_active' => $tp_active,
            'smt_active' => $smt_active,
            'tahun' => $tahun,
    ...
    public function update($id) {
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            // Dapatkan data berita yang ada di database
            $berita = $this->BeritaMisiAnak_model->get_misi_anak_by_id($id);

            // Ambil data input baru atau gunakan data lama jika kosong
            ...
            $data = [
                ...
                'story_tips' => $this->input->post('story_tips'),           // Kolom baru
                'fakta_singkat' => $this->input->post('fakta_singkat'),     // Kolom baru
                'gambar' => !empty($gambar_url) ? $gambar_url : $berita->gambar,
                'file_pdf' => !empty($file_pdf_url) ? $file_pdf_url : $berita->file_pdf,
                'file_ppt' => !empty($file_ppt_url) ? $file_ppt_url : $berita->file_ppt
            ];

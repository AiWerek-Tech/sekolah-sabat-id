...
<div class="header__top-hat show-at--large bg--black pad-half align--right">
    <span class="icon icon__logo" alt="ISI LOGO TOP DISINI">
        <img src="<?= base_url('assets') ?>/image/icon/aiwerek-ministry.png">
    </span>
...
<div class="header__inner">
    ...
    <div class="header__unify-logo-nav">
        <a href="<?= base_url('') ?>"
            ...
            <img src="<?= base_url('assets') ?>/image/logo_horizontal.png" class="logo"
        ...
        <a href="<?= base_url('') ?>"
            ...
            <img src="<?= base_url('assets') ?>/image/logo_square.png" class="logo"
                style=" margin-bottom: 0.625rem !important;" alt="Sabbath School and Personal Ministries Logo" />
        </a>

<!-- application/views/modals/absg/modal_lesson5.php -->
<div class="modal fade" id="modalLesson5" tabindex="-1" aria-labelledby="modallesson5Label" aria-hidden="true">
      <div class="modal-dialog modal-lg">
          <div class="modal-content">
              <div class="modal-header d-flex justify-content-between align-items-center">
                <span class="modal-title text-center flex-grow-1" id="modallesson5Label">
                    Pelajaran 5 - <?= $judul_pelajaran5?> (<?= $triwulan?>)
                </span>
                <div>
                    <a href="#" id="fullscreenIcon5" class="mr-3 text-secondary"><i class="fas fa-expand-arrows-alt"></i></a>
              ...
              <div class="modal-body">
                  <iframe id="lesson5Content" src="https://sabbath-school.adventech.io/in/2024-03/05/01" style="width: 100%; height: 100%; border: none;" scrolling="auto"></iframe>
              </div>
